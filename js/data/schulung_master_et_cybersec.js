...
(function () {
    ...
    const QUIZ_KRYPTO = [
        ...
        q('Welche zentrale Handshake-Aenderung bringt TLS 1.3 gegenueber TLS 1.2?',
            ['Vollhandshake in 1-RTT statt 2-RTT, optionales 0-RTT mit PSK; alle Nachrichten nach ServerHello sind verschluesselt', 'Verschluesselung beginnt erst mit dem dritten Flight', 'Server muss weiterhin separates ServerKeyExchange senden', 'Session-Resumption entfaellt vollstaendig'], 0,
            'RFC 8446 §1: TLS 1.3 reduziert den Vollhandshake auf 1-RTT, fuehrt 0-RTT-Early-Data fuer PSK ein und verschluesselt ab dem ServerHello-Folgeverkehr unter dem Handshake-Traffic-Secret.'),
        q('Welche Cipher-Suite ist in TLS 1.3 gemaess RFC 8446 §9.1 NICHT mehr zulaessig?',
            ['TLS_AES_128_GCM_SHA256', 'TLS_AES_256_GCM_SHA384', 'TLS_CHACHA20_POLY1305_SHA256', 'TLS_RSA_WITH_AES_128_CBC_SHA'], 3,
            'RFC 8446 §1.2 / §9.1: TLS 1.3 erlaubt nur AEAD-Suites mit (EC)DHE-Schluesselaustausch; RSA-Key-Transport- und CBC-MAC-then-Encrypt-Suites sind entfernt.'),
        q('Welche Schluesselableitung verwendet TLS 1.3 intern?',
            ['SP 800-56A KDF', 'SP 800-38D GHASH', 'reines RFC 5869 HKDF ohne Label-Schema', 'HKDF-Expand-Label / Derive-Secret nach RFC 8446 §7.1'], 3,
            'RFC 8446 §7.1 definiert ein Label-basiertes HKDF-Schema (HKDF-Expand-Label, Derive-Secret), das aus Early-/Handshake-/Master-Secret die Traffic-Keys ableitet.'),
        q('Was charakterisiert AES-GCM-SIV (RFC 8452) gegenueber AES-GCM?',
            ['Nonce-Misuse-Resistance: bei Nonce-Wiederverwendung leakt nur, ob Klartexte gleich waren — keine Tag-Faelschung', 'Etwa 30% hoehere Rohgeschwindigkeit', 'Verzicht auf den Authentication-Tag', 'Stream-Cipher-Eigenschaft ohne Block-Operation'], 0,
            'RFC 8452 §1: AES-GCM-SIV (Synthetic IV, Gueron/Lindell 2015) ist nonce-misuse-resistent — der Tag haengt deterministisch vom Klartext ab, sodass Joux-2006-Faelschungen entfallen.'),
        q('Welche X.509-Extension begrenzt nach RFC 5280 die zulaessige Pfadlaenge unterhalb einer Sub-CA?',
            ['BasicConstraints mit pathLenConstraint', 'KeyUsage mit keyCertSign', 'ExtendedKeyUsage mit serverAuth', 'SubjectKeyIdentifier'], 0,
            'RFC 5280 §4.2.1.9: pathLenConstraint in BasicConstraints gibt die maximale Anzahl nicht-selbstausgestellter Sub-CAs unter dieser CA an. Muss kritisch markiert sein, wenn cA=TRUE.'),
        q('Was bewirkt die X.509-Extension "Name Constraints" (RFC 5280 §4.2.1.10)?',
            ['Beschraenkt eine Sub-CA auf zulaessige DNS-/IP-/E-Mail-/DN-Namensraeume', 'Erzwingt OCSP-Stapling', 'Definiert die zulaessige Schluessellaenge', 'Verbietet Wildcard-Zertifikate generell'], 0,
            'RFC 5280 §4.2.1.10: NameConstraints (kritisch in der Sub-CA) erlaubt der ausstellenden CA, den erlaubten Namensraum auf bestimmte Subtrees einzugrenzen — zentrales Mittel fuer eingeschraenkte interne CAs.'),
        q('Welche TLS-Erweiterung verlangt vom Server, OCSP-Stapling tatsaechlich zu liefern, sonst Connection-Abort?',
            ['OCSP Must-Staple (RFC 7633, TLS Feature Extension)', 'Server-Name-Indication', 'ALPN', 'Encrypted Client Hello'], 0,
            'RFC 7633: das X.509-Feature "status_request" im TLS-Feature-Profil bindet das Zertifikat an die Bereitstellung einer OCSP-Stapling-Antwort; fehlt sie, MUSS der Client den Verbindungsaufbau abbrechen.'),
        q('Welche Aussage zu ML-KEM (FIPS 203:2024) ist korrekt?',
            ['ML-KEM ist ein Key-Encapsulation-Mechanism — der Sender erzeugt das Shared-Secret und sendet das Encapsulation-Ciphertext an den Empfaenger; kein klassischer Diffie-Hellman-Austausch', 'ML-KEM ist ein symmetrisches Verfahren', 'ML-KEM basiert auf elliptischen Kurven', 'ML-KEM benoetigt keinen oeffentlichen Schluessel'], 0,
            'FIPS 203:2024 §3 / §6: ML-KEM (Module-Lattice-Based KEM, basierend auf CRYSTALS-Kyber) ist ein KEM auf Modul-LWE; Encaps liefert (ct, K), Decaps rekonstruiert K aus ct und sk.'),
        q('Welche NIST-Sicherheitskategorie hat ML-KEM-768 nach FIPS 203:2024?',
            ['Kategorie 1 (Aequivalent AES-128)', 'Kategorie 2', 'Kategorie 5 (Aequivalent AES-256)', 'Kategorie 3 (Aequivalent AES-192)'], 3,
            'FIPS 203:2024 §1.1 / Tab. 1: ML-KEM-512 -> Kat. 1, ML-KEM-768 -> Kat. 3, ML-KEM-1024 -> Kat. 5. CNSA 2.0 verlangt mindestens ML-KEM-1024 fuer NSS bis 2035.'),
        q('Welche PQC-Signatur ist nach FIPS 204:2024 als allgemeiner Standard fuer digitale Signaturen vorgesehen?',
            ['ML-DSA (Module-Lattice Digital Signature Algorithm, basierend auf CRYSTALS-Dilithium)', 'ECDSA P-384', 'RSA-PSS-3072', 'Ed25519'], 0,
            'FIPS 204:2024: ML-DSA in den Parametersaetzen ML-DSA-44/65/87 ist die NIST-Hauptsignatur fuer den PQC-Uebergang. ECDSA/RSA bleiben klassisch zulaessig, sind aber Shor-anfaellig.'),
        q('Wofuer wird SLH-DSA (FIPS 205:2024) typischerweise eingesetzt?',
            ['High-Volume-Web-TLS auf Massenservern', 'IoT-Bulk-Datenverschluesselung', 'JWT-Signaturen mit minimaler Bandbreite', 'Langlebige hash-basierte Signaturen, z.B. Firmware-/Code-Signing als konservatives Backup neben ML-DSA'], 3,
            'FIPS 205:2024: SLH-DSA (basierend auf SPHINCS+) ist hash-basiert (Sicherheit nur auf Hash-Annahmen) und damit konservativster PQC-Kandidat; Trade-off ist die grosse Signatur (~7-30 KB).'),
        q('Was beschreibt eine "Hybrid"-PQC-Migration in TLS?',
            ['Kombination eines klassischen Schluesselaustauschs (z.B. X25519) und eines PQ-KEM (z.B. ML-KEM-768) — das Shared-Secret wird aus beiden abgeleitet, die Verbindung ist sicher solange einer der beiden Algorithmen haelt', 'Mischbetrieb von TLS 1.2 und TLS 1.3', 'Mix von HMAC und Poly1305 in einer Suite', 'Session-Resumption mit zwei verschiedenen Cipher-Suites'], 0,
            'IETF draft-ietf-tls-hybrid-design (2024): Hybrid-Key-Exchange kombiniert klassisches und PQ-Geheimnis per Konkatenation/HKDF — Sicherheitsaussage ist disjunktiv ("solange ein Bestandteil sicher ist").'),
        q('Welche FIPS-140-3-Stufe verlangt aktive Erkennung und Reaktion auf Umgebungsangriffe ueber Spannung/Temperatur?',
            ['Level 1', 'Level 2', 'Level 3', 'Level 4'], 3,
            'FIPS 140-3 §7 / Annex A: Level 4 fordert Environmental Failure Protection (EFP) bzw. Environmental Failure Testing (EFT) gegen Voltage-/Temperature-Out-of-Range — Level 3 verlangt nur tamper-detection mit Zeroization.'),
        q('Welche Anforderung an die Schluesselgenerierung stellt FIPS 140-3 in Verbindung mit NIST SP 800-90?',
            ['Schluessel duerfen ausschliesslich in Software erzeugt werden', 'AES-Schluessel sind auf 128 bit beschraenkt', 'Schluessel werden aus Anwender-Passwoertern abgeleitet', 'Verwendung eines validierten DRBG nach SP 800-90A r1 mit gepruefter Entropie-Quelle nach SP 800-90B und ggf. Aufbau nach SP 800-90C'], 3,
            'FIPS 140-3 verlangt approved-DRBG nach SP 800-90A r1 (Hash_DRBG, HMAC_DRBG, CTR_DRBG); Entropie-Quelle muss SP 800-90B-konform validiert sein; SP 800-90C beschreibt die Komposition.'),
        q('Wofuer steht die "Cryptoperiod" eines Schluessels nach NIST SP 800-57 r5?',
            ['Die definierte Nutzungsdauer eines Schluessels fuer eine konkrete kryptographische Funktion, nach deren Ablauf der Schluessel rotiert oder zerstoert wird', 'Die Berechnungsdauer fuer einen Quantenangriff', 'Die Lebensdauer der gesamten X.509-Zertifizierungskette', 'Die Dauer einer einzelnen TLS-Session'], 0,
            'NIST SP 800-57 r5 §5.3: Cryptoperiod = Originator Usage Period (OUP) plus Recipient Usage Period (RUP); begrenzt Exposition und Schaden bei Kompromittierung.'),
        q('Wie lang ist nach NIST SP 800-57 r5 typischerweise die Originator Usage Period (OUP) eines symmetrischen Data-Encryption-Keys?',
            ['1 Tag', '1 Stunde', '5-10 Jahre', 'Bis zu 2 Jahre'], 3,
            'NIST SP 800-57 r5 Tab. 1: Symmetric Data Encryption Key — OUP <= 2 Jahre, RUP <= OUP + 3 Jahre. Werte sind Obergrenzen, Risikoanalyse kann strenger sein.'),
        q('Was sieht NIST SP 800-57 r5 fuer einen als "Compromised" markierten Schluessel vor?',
            ['Sofortiger Widerruf, Re-Verschluesselung der betroffenen Daten und CRL-/OCSP-Eintrag bei zugehoerigen Zertifikaten', 'Normale Weiternutzung bis zum Ablauf der Cryptoperiod', 'Rein archivierende Aufbewahrung ohne Massnahmen', 'Wiederherstellung aus Backup und Weiternutzung'], 0,
            'NIST SP 800-57 r5 §8.3.5: Compromised-Status loest unverzueglich Revocation aus; betroffene Daten muessen mit neuem Key re-verschluesselt werden; offentliche Schluessel werden via CRL/OCSP gesperrt.'),
        q('Welche Algorithmen empfiehlt NIST SP 800-38F fuer Key-Wrapping?',
            ['AES-CBC', 'AES-CTR mit angehaengtem MAC', 'RSA-OAEP', 'AES-KW oder AES-KWP'], 3,
            'NIST SP 800-38F §6: AES-KW (Key Wrap) und AES-KWP (Key Wrap with Padding) sind die approved-Methoden; KWP erlaubt beliebige Schluessel-Bytelaengen, KW arbeitet auf 64-bit-Bloecken.'),
        q('Was ist die Hauptmotivation eines Hardware-Security-Module (HSM) gegenueber rein softwarebasiertem Schluesselmanagement?',
            ['Private Schluessel werden im HSM erzeugt und verlassen es niemals im Klartext; alle Krypto-Operationen erfolgen modul-intern, Tamper-Resistance schuetzt vor physischem Auslesen', 'Hoehere Rohgeschwindigkeit als CPU-AES-NI', 'Niedrigere Anschaffungskosten', 'Groessere algorithmische Flexibilitaet als Software-Bibliotheken'], 0,
            'BSI TR-02102-1 / FIPS 140-3: HSMs (Level 3-4) garantieren Schluesselbindung an das Modul (non-extractable), nutzen approved-DRBGs und bieten tamper-resistente Gehaeuse mit Zeroization.'),
        q('Wofuer dient eine "Key Ceremony" bei Root-CA-Schluesseln?',
            ['Automatische Schluesselrotation alle 24 Stunden', 'Automatisches Re-Keying via ACME', 'Routinemaessige Pen-Tests gegen die CA', 'Dokumentiertes Mehr-Personen-Verfahren zur Erzeugung und Aktivierung des Root-Schluessels in einer kontrollierten, auditierten Umgebung mit Split-Knowledge / m-of-n-Schwellwertkontrolle'], 3,
            'CA/Browser Forum Baseline Requirements §6.2 sowie WebTrust for CA: Root-Key-Generation MUSS unter Mehr-Augen-Prinzip in einer geschuetzten Umgebung durchgefuehrt und revisionssicher protokolliert werden (Tamper-Evident-Bag, Video-Aufzeichnung, Auditor-Anwesenheit).')
    ];
    ...
    const QUIZ_CAPSTONE = [
        ...
        // --- Pool 5: Scope, ISMS & Risk (TOPUP v66, +10) ---
        q('Welche Aktivitaet ist nach IEC 62443-3-2:2020 ZCR 2 vorgeschrieben?',
            ['Detaillierte Schwachstellenscans', 'High-Level-Risk-Assessment der gesamten Anlage', 'Penetrationstest der Steuerung', 'Code-Review der Firmware'], 1,
            'IEC 62443-3-2:2020 §4.3 (ZCR 2) verlangt vor der Zonen-/Conduit-Definition ein initiales High-Level-Risk-Assessment, um den Bedarf einer detaillierten Bewertung festzustellen.'),
        q('Welche Information muss der Risk-Owner gemaess ISO/IEC 27001:2022 §6.1.3 dokumentieren?',
            ['Nur die identifizierten Risiken', 'Risikobehandlungsoptionen und residuale Risikoakzeptanz', 'Nur die Restrisiken', 'Nur die Massnahmen'], 1,
            'ISO/IEC 27001:2022 §6.1.3 lit. a-f verlangt vom Risk-Owner die Genehmigung sowohl des Risk-Treatment-Plans als auch die Akzeptanz der Restrisiken.'),
        q('Welche Phase im PDCA-Zyklus eines ISMS fokussiert die Korrektur-/Praeventivmassnahmen?',
            ['Plan', 'Do', 'Check', 'Act'], 3,
            'ISO/IEC 27001:2022 Anhang ZA (PDCA): „Act" umfasst Korrekturmassnahmen, Continual Improvement und Management Review-Ergebnisse.'),
        q('Welcher CIS-Control v8 (Implementation Group 1) ist Pflicht-Basis fuer KMU?',
            ['CIS Control 1 (Inventory and Control of Enterprise Assets)', 'CIS Control 13 (Network Monitoring)', 'CIS Control 18 (Penetration Testing)', 'CIS Control 20 (Red Team)'], 0,
            'CIS Controls v8 (2021) IG1 umfasst die 56 Safeguards der Basis-Hygiene; CIS-Control-1 (Asset Inventory) ist Voraussetzung fuer alle weiteren Controls.'),
        q('Welche Methodik liefert eine quantitative Bewertung von Angriffspfaden in komplexen Netzen?',
            ['Attack Trees (Schneier 1999)', 'PASTA (UcedaVelez/Morana 2015)', 'STRIDE', 'CVSS v3.1'], 1,
            'PASTA (Process for Attack Simulation and Threat Analysis, UcedaVelez/Morana 2015) ist eine 7-stufige risikozentrierte Methodik, die Angriffspfade simuliert und quantitativ bewertet.'),
        q('Welche EU-Verordnung verlangt fuer Hochrisiko-KI-Systeme ein dokumentiertes Risikomanagement?',
            ['DSGVO Art. 35', 'EU AI Act Art. 9', 'NIS-2 Art. 21', 'CRA Art. 13'], 1,
            'Verordnung (EU) 2024/1689 (AI Act) Art. 9 verlangt fuer Hochrisiko-KI-Systeme ein „Risikomanagementsystem", das ueber den gesamten Lebenszyklus gepflegt wird.'),
        q('Welche Schutzbedarfskategorie nach BSI 200-2 entspricht „existenzbedrohend"?',
            ['Normal', 'Hoch', 'Sehr hoch', 'Kritisch'], 2,
            'BSI 200-2:2024 §8.2.3: Schutzbedarfskategorie „sehr hoch" bedeutet, dass eine Schadensauswirkung existenzbedrohende Ausmasse erreichen kann.'),
        q('Welche IEC-62443-Foundational-Requirement adressiert „Identification and Authentication Control"?',
            ['FR1', 'FR2', 'FR3', 'FR4'], 0,
            'IEC 62443-1-1:2009 §5.6 definiert FR1 (Identification and Authentication Control); FR2 ist Use Control, FR3 System Integrity, FR4 Data Confidentiality.'),
        q('Welche Methode der OCTAVE-Allegro-Familie eignet sich fuer kleine Organisationen mit Asset-Fokus?',
            ['OCTAVE-S', 'OCTAVE Allegro', 'OCTAVE FORTE', 'OCTAVE Classic'], 0,
            'CERT/SEI OCTAVE-S (2005) ist die Variante fuer kleine Organisationen (< 100 Personen), 3 Phasen mit 8 Prozessen, asset-zentriert.'),
        q('Welche Stakeholder-Rolle ist im RACI eines Capstones fuer das Sign-Off des Treatment-Plans „Accountable"?',
            ['CISO', 'Risk-Owner (Geschaeftsbereichsleitung)', 'Auditor', 'Plant Engineer'], 1,
            'ISO/IEC 27001:2022 §6.1.3 lit. f: Der Risk-Owner — typischerweise Geschaeftsbereichsleitung — ist verantwortlich fuer Genehmigung; CISO ist Responsible/Consulted.'),

        // --- Pool 6: Threat & Detection (TOPUP v66, +10) ---
        q('Welcher MITRE-ATT&CK-Tactic-Code adressiert „Defense Evasion" im Enterprise-Modell?',
            ['TA0005', 'TA0006', 'TA0007', 'TA0011'], 0,
            'MITRE ATT&CK Enterprise v15 (2024): Defense Evasion = TA0005, Credential Access = TA0006, Discovery = TA0007, Command and Control = TA0011.'),
        q('Welche Detektion-Kennzahl misst die Zeit zwischen Erstkompromittierung und SOC-Alarm?',
            ['MTTR', 'MTTD', 'TTC', 'MTBF'], 1,
            'Mandiant M-Trends 2024 nutzt MTTD (Mean Time to Detect, ehem. „Dwell Time") als Standardkennzahl; im 2023 global 10 Tage, in EMEA hoeher.'),
        q('Welcher Standard normiert das Format fuer Cyber-Threat-Intelligence-Austausch zwischen Plattformen?',
            ['STIX 2.1 (OASIS 2021)', 'CVE-JSON', 'YARA', 'OpenIOC'], 0,
            'OASIS STIX 2.1 (Jun. 2021) ist der etablierte Industrie-Standard fuer strukturierten CTI-Austausch; TAXII 2.1 ist das Transportprotokoll.'),
        q('Welches NIST-Dokument beschreibt einen Vulnerability Disclosure Process fuer Hersteller?',
            ['NIST SP 800-115', 'NIST SP 800-216 (2023)', 'NIST SP 800-53r5', 'NIST SP 800-160 Vol. 1 r1'], 1,
            'NIST SP 800-216 (Sep. 2023) „Recommendations for Federal Vulnerability Disclosure Guidelines" beschreibt einen koordinierten Disclosure-Prozess fuer Bundesbehoerden und Hersteller.'),
        q('Welche Verzeichnis-Quelle aggregiert exploit-relevante Zusatzinformationen zu CVEs?',
            ['MITRE CWE', 'CISA KEV-Katalog', 'NVD CVSS-Vektor', 'OWASP ASVS'], 1,
            'CISA Known Exploited Vulnerabilities Catalog (seit BOD 22-01, 2021) listet aktiv ausgenutzte CVEs mit Due-Date — Pflicht-Patch-Quelle fuer US-Bundesbehoerden und faktischer Industrie-Standard.'),
        q('Welcher Sigma-Modifizierer normalisiert den Vergleich auf Gross-/Kleinschreibung?',
            ['contains', 'startswith', 'i (case-insensitive)', 'endswith'], 2,
            'SigmaHQ Specification 2.x (2024) definiert den Modifizierer `|i` (oder `|cased: false`) fuer case-insensitive Vergleiche; Standardverhalten ist case-sensitive.'),
        q('Welche zwei Frueh­indikatoren auf Domain-Controller-Ebene zeigen typischerweise „Pass-the-Hash"?',
            ['Event 4624 Type 3 + NTLM', 'Event 4634 + Kerberos', 'Event 4768 + AES256', 'Event 5140 + SMB1'], 0,
            'Microsoft Security Auditing Reference (2024): Event 4624 (Successful Logon) Logon Type 3 (Network) mit Authentication-Package NTLM ist klassischer Indikator fuer PtH; Kerberos waere normal.'),
        q('Welcher Threat-Intelligence-Reifegrad-Standard nutzt die Stufen Strategic/Operational/Tactical/Technical?',
            ['SANS CTI-Pyramide', 'MITRE PRE-ATT&CK', 'CTI-Maturity-Model SANS Whitepaper (Roberts 2018)', 'OWASP CTI'], 2,
            'Robert M. Lee „SANS 2018 CTI Survey": Strategic (CEO-Ebene), Operational (Kampagnen), Tactical (TTPs), Technical (IOCs). Standardrahmen fuer CTI-Reife.'),
        q('Welche Faehigkeit liefert Diamond-Model-Analyse, die Cyber Kill Chain nicht abbildet?',
            ['Sequenz der Angriffsschritte', 'Verknuepfung von Adversary/Capability/Infrastructure/Victim mit Pivoting', 'Forensik-Beweise', 'Audit-Trail'], 1,
            'Caltagirone et al. „The Diamond Model" (2013): Vier Kernknoten + Pivoting-Eigenschaften — ermoeglicht Cluster-Bildung und Attribution, die die lineare Kill Chain nicht leistet.'),
        q('Welche EPSS-Schwelle gilt 2024 in der Praxis als „akut, sofortige Mitigation"?',
            ['EPSS ≥ 0.10', 'EPSS ≥ 0.50', 'EPSS ≥ 0.70 (FIRST-Tag „Top 7 %")', 'EPSS ≥ 0.99'], 2,
            'FIRST EPSS v3 (2023) Statistik: EPSS ≥ 0.70 markiert die obersten ~7 % aller CVEs; in CISA-/SANS-Empfehlung 2024 als Schwelle fuer sofortige Patch-Massnahmen.'),

        // --- Pool 7: Controls, Compliance & Recovery (TOPUP v66, +10) ---
        q('Welche ISO-27002:2022-Control adressiert Threat-Intelligence-Pflichten?',
            ['A.5.7 Threat Intelligence (neu)', 'A.5.1', 'A.8.16', 'A.6.7'], 0,
            'ISO/IEC 27002:2022 fuehrte 11 neue Controls ein, darunter A.5.7 „Threat intelligence" — explizite Pflicht zur Sammlung und Verteilung relevanter CTI.'),
        q('Welches NIST-CSF-2.0-Funktion-Element kam 2024 gegenueber Version 1.1 neu hinzu?',
            ['Identify', 'Protect', 'Govern (neu in NIST CSF 2.0, 2024)', 'Detect'], 2,
            'NIST CSF 2.0 (Feb. 2024) fuehrte „Govern" als sechste Kernfunktion ein, neben Identify, Protect, Detect, Respond, Recover.'),
        q('Welche Pflicht ergibt sich aus EU CRA Art. 14 fuer Hersteller bei aktiv ausgenutzten Schwachstellen?',
            ['Patch innerhalb 24 h', 'Meldung an ENISA und CSIRT innerhalb 24 h, Update an Nutzer „ohne unangemessene Verzoegerung"', 'Stilllegung der betroffenen Produkte', 'Oeffentliche Bekanntgabe binnen 4 Wochen'], 1,
            'Verordnung (EU) 2024/2847 (CRA) Art. 14: 24-h-Early-Warning an ENISA/CSIRT, 72-h-Vorfallsbericht, 14-Tage-Schlussbericht; Sicherheitsupdates ohne unangemessene Verzoegerung.'),
        q('Welche RTO/RPO-Faustregel ist Standard fuer „Tier 1 — kritisch" im BCM?',
            ['RTO ≤ 24 h, RPO ≤ 1 h', 'RTO ≤ 72 h, RPO ≤ 24 h', 'RTO ≤ 1 Woche, RPO ≤ 1 Tag', 'RTO unbestimmt'], 0,
            'ISO 22301:2019 verlangt geschaeftsorientierte Werte; Industrie-Praxis (BCI Good Practice Guidelines 2018) Tier 1 typisch RTO ≤ 24 h, RPO ≤ 1 h.'),
        q('Welche zwei Mindest-Tests verlangt ISO 22301:2019 §8.5 jaehrlich?',
            ['Penetration- und Code-Review', 'Restore-Test und Krisenuebung', 'Disaster-Recovery-Drill und Phishing-Test', 'Schwachstellenscan und Audit'], 1,
            'ISO 22301:2019 §8.5 „Exercise programme" verlangt regelmaessige Uebung; BSI-Standard 200-4:2024 konkretisiert Restore-Tests und Krisenstabsuebungen jaehrlich.'),
        q('Welche Pflicht ergibt sich aus NIS-2 Art. 21 Abs. 2 fuer Geschaeftsleitungen?',
            ['Optionale Schulung', 'Pflicht-Schulung zu Cybersicherheit und Risikomanagement (mind. einmal)', 'Externe Auditierung', 'CISO-Zertifizierung'], 1,
            'Richtlinie (EU) 2022/2555 (NIS-2) Art. 20 Abs. 2: Leitungsorgane wichtiger/wesentlicher Einrichtungen muessen Cybersicherheits-Schulungen besuchen und vergleichbare Schulungen fuer Mitarbeiter foerdern.'),
        q('Welche zwei Faktoren erhoehen die Wahrscheinlichkeit erfolgreicher Ransomware-Wiederherstellung?',
            ['Online-Backups und ein zentraler Schluessel', 'Immutable/Offline-Backups und getesteter Restore-Prozess', 'RAID-5 und tagliches Snapshot', 'WORM-Disk und Cloud-Sync'], 1,
            'ENISA Threat Landscape for Ransomware (Jul. 2024) und BSI Lagebericht 2024: Immutable (z.B. S3-Object-Lock) bzw. Air-Gap-Backups und regelmaessig getestete Restores sind die zwei wichtigsten Wiederherstellungs-Erfolgsfaktoren.'),
        q('Welche DORA-Test-Kategorie verlangt fuer signifikante Finanzentitaeten alle 3 Jahre Threat-Led Penetration Testing?',
            ['Standardtest', 'Vulnerability Scan', 'Threat-Led Penetration Testing (TLPT) nach TIBER-EU-Methodik', 'Red Team uebung'], 2,
            'Verordnung (EU) 2022/2554 (DORA) Art. 26 mit RTS (Oct. 2024): TLPT (basierend auf TIBER-EU 2018) ist alle 3 Jahre Pflicht fuer designierte Finanzentitaeten.'),
        q('Welche Klausel in ISO/IEC 27001:2022 verlangt eine interne Auditprogrammplanung?',
            ['§9.1', '§9.2', '§9.3', '§10.1'], 1,
            'ISO/IEC 27001:2022 §9.2 „Internal audit" verlangt ein dokumentiertes Auditprogramm inklusive Kriterien, Auditplan und Reporting an Management.'),
        q('Welcher BSI-Standard 2024 strukturiert das Business Continuity Management?',
            ['BSI 200-1', 'BSI 200-2', 'BSI 200-3', 'BSI 200-4 (neu, 2024)'], 3,
            'BSI-Standard 200-4 „Business Continuity Management" wurde 2024 erstmals als eigenstaendiger Standard veroeffentlicht; loest die alte BSI 100-4-Empfehlung ab.')
    ];
