...
> **Naechster Vorschlag (vom Agent gesetzt):** **P-CYBERSEC-08** (Incident Response, Forensik und Malware-Analyse — neues Master-Cybersec-Kapitel mit ≥4 Lehrseiten nach §23-Template + ≥50 quellenbelegte MCQ + mind. 2 Fall-/PBQ-Aufgaben).
> Begruendung: Die Architektur-Schicht ist mit P-ARCH-ITEM-SCHEMA (v36), P-ARCH-STABLE-QID (v37) und P-ARCH-VALIDATE-CLI (v41) so weit gelegt, dass der Inhaltsausbau ohne Schema-Drift weiterlaufen kann; der Validator ist ab jetzt Teil des Standard-Validation-Sets (AGENTS §13). Naechste sinnvolle Architektur-Schritte (P-ARCH-APPJSX-SPLIT, P-ARCH-LO-COMPETENCE) sind grosse Pakete mit viel Diff-Last und werden nach dem naechsten Curriculum-Block (Cybersec 8/9 + Capstone, Automation 5/6) gefahren. Logischer Folgeschritt fuer ein vollstaendiges Master-Cybersec ist daher IR/Forensik (NIST SP 800-61r2, ISO/IEC 27035, Chain of Custody, SIEM/EDR-Triage, Ransomware-Playbooks) — baut auf 7.3 (K8s-Audit, Falco-Detektion) und 7.4 (PAM-Session-Recording) auf und ist Voraussetzung fuer P-CYBERSEC-09 (Offensive) sowie den Capstone. Parallele Strecken P-AUTO-05/-06/-01-TOPUP und P-MED-AUDIT bleiben ready, sind aber nicht im selben Curriculum-Strang.
