...
| 5      | pool     | **Mathematik (100er Pool):** natuerliche Zahlen, Brueche, Dezimalzahlen, Groessen, Rechtecke. **Naturwissenschaften (NRW-KLP NW SI):** Physik (Magnetismus, Stromkreis, Licht/Schatten, Temperatur), Chemie (Stoffe & Aggregatzustaende, Wasser & Luft), Biologie (Pflanzen/Tiere/Mensch). **Geschichte (NRW-KLP Geschichte SI):** Steinzeit, Aegypten, Antikes Griechenland, Roemisches Reich (Einstieg). Englisch in Vorbereitung. |
| 6      | pool     | **Mathematik (100er Pool):** Bruchteile, Prozentrechnung, ganze Zahlen, Gleichungen, Dreiecke. **Naturwissenschaften (NRW-KLP NW SI):** Physik (Optik, Schall, Waermetransport), Chemie (Stofftrennung, Indikatoren, Reinstoffe), Biologie (Mensch, Wirbeltiere, Oekologie). **Geschichte:** Roemisches Reich vertieft, Voelkerwanderung, Karolinger/Lehnswesen, Kaiser/Papst, Stadt/Hanse, Kreuzzuege, Pest. Englisch in Vorbereitung. |
| 7      | pool     | **Mathematik (100er Pool):** lineare Gleichungen, Proportionalitaet, Prozentrechnung, lineare Funktionen, Terme. **Naturwissenschaften:** Physik (Mechanik, Einheiten), Chemie (Aggregatzustaende, Summenformeln), Biologie (Zelle, Oekosystem). **Geschichte:** Renaissance, Entdeckungen, Reformation, Dreissigjaehriger Krieg, Absolutismus, Aufklaerung. Englisch in Vorbereitung. |
| 8      | pool     | **Mathematik (100er Pool):** Steigung, Gleichungssysteme, Pythagoras, Potenzen, binomische Formeln. **Naturwissenschaften:** Physik (Elektrik, Arbeit/Leistung), Chemie (Atombau, Periodensystem), Biologie (Atmung, Verdauung, Kreislauf). **Geschichte:** Franzoesische Revolution, Napoleon, Vormaerz/1848, Industrialisierung, Reichsgruendung 1871. Englisch in Vorbereitung. |
| 9      | pool     | **Mathematik (100er Pool):** quadratische Gleichungen, Trigonometrie, Wahrscheinlichkeit, Aehnlichkeit, Statistik. **Naturwissenschaften:** Physik (Newton, Energie, Druck), Chemie (Saeuren/Basen, Salze), Biologie (Genetik-Grundlagen, Evolution). **Geschichte:** Kaiserreich, Erster Weltkrieg, Weimarer Republik, Aufstieg NS. Englisch in Vorbereitung. |
| 10     | pool     | **Mathematik (100er Pool):** Exponentialfunktionen, Potenzen, Trigonometrie, Koerpergeometrie, quadratische Gleichungen. **Naturwissenschaften:** Physik (Atombau, Optik), Chemie (Organische Chemie Einstieg), Biologie (Molekularbiologie, Biodiversitaet). **Geschichte:** Zweiter Weltkrieg, Shoah, Besatzung, BRD/DDR, Kalter Krieg, Wiedervereinigung 1989/90, Europa, Globalisierung. Englisch in Vorbereitung. |
...
**Geschichts-Pools (Klasse 5–10, seit v71):** Pro Klassenstufe ein 50er Pool mit `{q, a}`-Schema (Runtime-Anreicherung zu `{q, a, f, s}` ueber `schuelerFormulaFor`/`schuelerSolutionFor`). Themen folgen dem **NRW-Kernlehrplan Geschichte Sekundarstufe I** (Realschule/Gesamtschule/Gymnasium G9 in der jeweils aktuellen Fassung): Klasse 5 Steinzeit/Aegypten/Antike, Klasse 6 Mittelalter, Klasse 7 Reformation/Absolutismus/Aufklaerung, Klasse 8 Revolution/Industrialisierung/Reichsgruendung, Klasse 9 Kaiserreich/WK1/Weimar/NS, Klasse 10 WK2/Kalter Krieg/Wiedervereinigung/Globalisierung. Antworten sind kurze Strings (Jahreszahl, Ort, Akteur, Schluesselbegriff) und werden ueber `normalize()` verglichen; Umlaute durch `ae/oe/ue/ss` ersetzt. Aufgaben sind handgeprueft gegen die NRW-Lehrplaene (§8).
