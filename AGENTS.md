...
## 17. Schüler-Bereich (Mathematik Klasse 1–10, Naturwissenschaften/Geschichte/Sprachen Klasse 5–10)
...
- Eigene Datendatei `js/data/schueler.js` mit globalem `window.SCHUELER`; seit v73 zusaetzlich `js/data/schueler_200_topups.js` als append-only Erweiterung fuer 200er-Pools und Sprachen.
...
```js
{
    ...
    subjects: { mathe: { label: 'Mathematik' }, englisch: { label: 'Englisch' }, franzoesisch: { label: 'Franzoesisch' }, latein: { label: 'Latein' } },
    content: {
...
| 5      | pool     | **Mathematik/Physik/Chemie/Biologie/Geschichte je 200 Items.** Sprache: Englisch, Franzoesisch, Latein je 200 Vokabel-Abfragen + 200 Grammatikfragen. Themen: Grundrechenarten, NW-Einstieg, Steinzeit/Aegypten/Antike, Sprachgrundlagen A1/erste lateinische Formen. |
| 6      | pool     | **Mathematik/Physik/Chemie/Biologie/Geschichte je 200 Items.** Sprache: Englisch, Franzoesisch, Latein je 200 Vokabel-Abfragen + 200 Grammatikfragen. Themen: Brueche/Prozent/Geometrie, Optik/Schall/Stofftrennung/Mensch/Oekologie, Mittelalter, A1/A2-Sprachprogression. |
| 7      | pool     | **Mathematik/Physik/Chemie/Biologie/Geschichte je 200 Items.** Sprache: Englisch, Franzoesisch, Latein je 200 Vokabel-Abfragen + 200 Grammatikfragen. Themen: lineare Gleichungen/Funktionen, Mechanik/Atome/Zelle/Oekosystem, Renaissance/Reformation/Absolutismus, A2-Grammatik/lateinische Kasus und AcI. |
| 8      | pool     | **Mathematik/Physik/Chemie/Biologie/Geschichte je 200 Items.** Sprache: Englisch, Franzoesisch, Latein je 200 Vokabel-Abfragen + 200 Grammatikfragen. Themen: LGS/Pythagoras/Potenzen, Elektrik/Atombau/Verdauung/Kreislauf, Revolution/Industrialisierung, A2/B1-Sprachprogression. |
| 9      | pool     | **Mathematik/Physik/Chemie/Biologie/Geschichte je 200 Items.** Sprache: Englisch, Franzoesisch, Latein je 200 Vokabel-Abfragen + 200 Grammatikfragen. Themen: Quadratik/Trigonometrie/Stochastik, Energie/Druck/Saeure/Base/Genetik/Evolution, Kaiserreich/WK1/Weimar/NS, B1-Grammatik/lateinische Nebensaetze. |
| 10     | pool     | **Mathematik/Physik/Chemie/Biologie/Geschichte je 200 Items.** Sprache: Englisch, Franzoesisch, Latein je 200 Vokabel-Abfragen + 200 Grammatikfragen. Themen: Exponentialfunktionen/Koerper/Trigonometrie, Radioaktivitaet/Optik/Organik/Molekularbiologie/Biodiversitaet, WK2/Shoah/Kalter Krieg/Wiedervereinigung/Globalisierung, B1-Konsolidierung/lateinische Stilistik. |
...
**Sprach-Pools (Englisch, Franzoesisch, Latein Klasse 5–10, seit v73):** Pro (Klasse, Sprache) ein 400er Pool mit `{q, a, f, s, kind}`; genau 200 Items tragen `kind: 'vocab'`, genau 200 Items `kind: 'grammar'`. Die Pools sind curriculum-orientiert (NRW-KLP SI / CEFR A1-B1 bzw. Latein-KLP Sprache/Text/Kultur), aber **nicht** lehrwerksspezifisch: Die Kernlehrplaene schreiben keine einheitliche, schulbuchuebergreifende Vokabelliste mit exakt 200 Woertern pro Jahrgang vor. Wenn ein konkretes Lehrwerk (z.B. Green Line, Decouvertes, Pontes/Cursus/Prima) bedient werden soll, muss die autorisierte Vokabelliste nachgereicht und append-only eingepflegt werden.
...
- **Neue Mathe-/NW-/Geschichte-Aufgabe für Klasse 5–10 hinzufügen**: append-only in die passende Basisfunktion oder in `js/data/schueler_200_topups.js`; Schema `{q,a,f,s}` direkt liefern, keine bestehenden Items verschieben. Validator fordert mindestens 200 Items pro (Klasse, Fach) und die Trainingsfelder.
...
- **Sprach-Aufgabe Klasse 5–10 hinzufügen**: append-only in `js/data/schueler_200_topups.js`. Vokabelitems muessen `kind: 'vocab'`, Grammatikitems `kind: 'grammar'` tragen. Validator fordert mindestens 200 Vokabel- und 200 Grammatikitems pro (Klasse, Sprache). `normalize()` toleriert seit v73 Akzente, Apostrophe, Satzzeichen, Leerraum und Gross-/Kleinschreibung.
