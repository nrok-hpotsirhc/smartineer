...
- **Schüler-Bereich**: Mathematik Klasse 1–10 plus Deutsch, Naturwissenschaften, Geschichte und Sprachen Klasse 5–10; Mathe 5–10, Deutsch, Physik, Chemie, Biologie und Geschichte bieten je 200 Aufgaben. Englisch/Französisch/Latein haben je Klasse 100 Zahlen-, 100 Vokabel- und 200 Grammatik-Abfragen mit einklappbarer Abschnittstrennung und eigenen Training-/Quiz-Starts. Alle Mittelstufenfächer nutzen getrenntes Training mit Formel/Merksatz (default eingeklappt, per Klick auf "Tipp anzeigen" einblendbar), Musterlösung und eigener geloest-Markierung sowie ein 10-Fragen-Quiz.
