...
> **Naechster Vorschlag (vom Agent gesetzt):** **P-CYBERSEC-09** (Offensive Security und Security Testing — neues Master-Cybersec-Kapitel mit ≥4 Lehrseiten nach §23-Template + ≥50 quellenbelegte MCQ + mind. 2 Fall-/PBQ-Aufgaben).
> Begruendung: Curriculum-Strang Cybersec ist mit P-CYBERSEC-08 (v42) bei 8/9 Kapiteln; logischer naechster Schritt ist die offensive Perspektive (OWASP WSTG/ASVS, NIST SP 800-115, MITRE ATT&CK Enterprise, AD-Angriffspfade, Web/API-Security) — sie ergaenzt die jetzt bestehende defensive IR/Forensik-Saeule und ist Voraussetzung fuer den P-CYBERSEC-CAPSTONE. Parallele Strecken P-AUTO-05/-06, P-AUTO-01-TOPUP und P-MED-AUDIT bleiben ready, sind aber nicht im Cybersec-Strang. Architektur-Pakete (P-ARCH-APPJSX-SPLIT, P-ARCH-LO-COMPETENCE) bleiben hinter dem Curriculum-Block.
