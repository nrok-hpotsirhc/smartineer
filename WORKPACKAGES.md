...
> Begruendung: Curriculum-Strang Cybersec ist mit P-CYBERSEC-08 (v42) bei 8/9 Kapiteln; logischer naechster Schritt ist die offensive Perspektive (OWASP WSTG/ASVS, NIST SP 800-115, MITRE ATT&CK Enterprise, AD-Angriffspfade, Web/API-Security) — sie ergaenzt die jetzt bestehende defensive IR/Forensik-Saeule und ist Voraussetzung fuer den P-CYBERSEC-CAPSTONE. Quick-Win-Pakete P-UI-LOGIN-REACTIVATE/P-UI-KATEX-DETAILS-TOGGLE/P-ARCH-VALIDATE-WINDOWS-PATHS wurden in derselben Sitzung (v43) miterledigt; Architektur- und Inhalts-Pakete laufen weiter parallel.
