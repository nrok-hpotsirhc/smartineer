...
(function () {
    ...
    const PAGE_PRAXIS_VERWALTUNG = {
        ...
        html: ''
            ...
            + '<p>Antrag bei Pflegekasse → MD-Begutachtung. Hausarzt-Rolle: ärztliche Stellungnahme, klinische Befund-Zusammenfassung, häufig auch Erstantrags-Trigger. Leistungsarten (Pflegegeld § 37 SGB XI für Angehörigenpflege; Pflegesachleistung § 36 für Pflegedienste; Kombinationsleistung § 38; vollstationär § 43): die konkreten Eurobeträge je Pflegegrad sind seit dem Pflegeunterstützungs- und Entlastungsgesetz (PUEG, 2023) regelhaft dynamisiert (Anhebungen 1.1.2024, 1.1.2025; gesetzlich vorgesehene weitere Anpassung 1.1.2028 plus Inflations-Indexierung). Aktuelle Beträge daher nicht auswendig lernen, sondern bei Bedarf gegen die Pflegekassen-Mitteilung bzw. den GKV-Spitzenverband prüfen — IMPP-relevant ist die Systematik (Modul-Gewichtung, Punkteschwellen, Anspruchsgrundlagen), nicht der Tagespreis.</p>'
    ...
    const QUIZ_FA = [
        ...
        q('Welche Aussage zum Berentungsverfahren / Erwerbsminderungsrente (EM-Rente) trifft zu?',
            ...
            1,
            'EM-Rente (§ 43 SGB VI): volle EM bei &lt; 3 h/d, teilweise EM bei 3–&lt; 6 h/d Restleistungsvermögen. Beurteilung durch DRV-Gutachten (in der Regel über sozialmedizinische Dienste). Hausärzte: Befundberichte, keine sozialmedizinische Beurteilung. Hinzuverdienstgrenzen mit Reform zum 1.1.2023 deutlich angehoben und seitdem an die Bezugsgröße nach § 18 SGB IV gekoppelt — der aktuelle Jahreswert (volle EM-Rente bzw. teilweise EM-Rente) ist daher dynamisch und im laufenden Beratungsfall bei der DRV abzufragen.'),
