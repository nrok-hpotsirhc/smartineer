...
> **Naechster Batch-Anker (vom Agent gesetzt):** **P-ARCH-APPJSX-SPLIT** (Code-Hygiene; `js/app.jsx` ueber 3000 Zeilen, Compose-Aufwand vor weiteren Lernplattform-Mechaniken sinnvoll) oder Inhalts-Top-up wie **P-CYBERSEC-09** / **P-AUTO-05/-06** / **P-MED-AUDIT** zur Schliessung der Capstone-/Soll-Gaps. Alternativ **P-LP-MASTERY** (Bloom-Aggregation) als letztes offenes Block-H-Paket.
> Begruendung: Mit v59 ist P-ARCH-GLOSSARY live — Cybersec-Schulung fuehrt 37 Glossar-Eintraege, Reader/Quiz/Result rendern klickbare `.glossary-link`-Buttons, Document-Level-Click-Delegation oeffnet ein read-only-Modal, AGENTS §18.11 dokumentiert Schema/Marker/UX/Anti-Pattern. Damit ist Block G "Architektur & Datenmodell" bis auf P-ARCH-APPJSX-SPLIT und P-ARCH-DATA-LAZY abgearbeitet. Naechste Hebel: Code-Hygiene (App-Split, jsx-Datei >3000 Zeilen) oder Inhaltsausbau auf den noch dünnen Capstone-Kapiteln (Cybersec Kap.10, Automation Kap.7).
