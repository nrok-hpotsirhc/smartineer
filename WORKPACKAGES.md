...
> **Naechster Batch-Anker (vom Agent gesetzt):** **P-ARCH-APPJSX-SPLIT** (Code-Hygiene; `js/app.jsx` mittlerweile ~3400 Zeilen) oder Inhalts-Top-up wie **P-CYBERSEC-09-TOPUP** / **P-AUTO-09-TOPUP** / **P-MED-AUDIT** zur Schliessung der Capstone-/Soll-Gaps. Mittelfristig: Naturwissenschaften-Pools (k5-k10) inhaltlich verdichten und um Mathe-Pools fuer Klasse 5-10 ergaenzen (P-SCHUELER-NATWI-TOPUP, P-SCHUELER-MATHE-MITTELSTUFE).
> Begruendung: Mit v65 wurden 5 User-gemeldete Bugs/UX-Maengel fix abgearbeitet (Reader-Scroll-Top, Vollreset, TOC-Sichtbarkeit, Mastery-Label, Naturwiss-Skeletons k5-k10) sowie der Schueler-Bereich um 14 Naturwiss-Pools (~140 Aufgaben) erweitert. Die letzten grossen Hebel bleiben Code-Hygiene (App-Split) und Capstone-Inhaltsausbau.
