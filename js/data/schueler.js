...
(function () {
    ...
    function pool_k1_sachunterricht() {
        return [
            ...
            { q: 'Wo darfst du als Kind auf dem Gehweg gehen? (rechts, mitte, links)', a: 'rechts' },
    ...
    function pool_k2_sachunterricht() {
        return [
            ...
            { q: 'Wie heisst der Schmetterling, der gelb-schwarz ist und Honig macht? (das ist eigentlich)', a: 'biene' },
            { q: 'Welcher Tier hat Federn?', a: 'vogel' },
            { q: 'Welcher Tier hat Schuppen und lebt im Wasser?', a: 'fisch' },
            ...
            { q: 'Welche Bluete duftet stark und ist Mariens Symbol? (Rose, Tulpe, Gras)', a: 'rose' },
            ...
            { q: 'Welche Jahreszeit ist am kuerzesten Tag-/Nacht-Lichtmoment unausgeglichen, dunkel?', a: 'winter' },
            ...
            { q: 'Wie heisst der Beruf, der Briefe austraegt?', a: 'briefträger' },
    ...
    function pool_k3_sachunterricht() {
        return [
            ...
            { q: 'In welchem Land liegt Tokio?', a: 'japan' },
            ...
            { q: 'Welche Energiequelle der Erde ist die Sonne? (Strahlung)', a: 'strahlung' },
    ...
    function pool_k4_sachunterricht() {
        return [
            ...
            { q: 'Wie heisst die Hauptstadt von Italien?', a: 'rom' },
            { q: 'Wie heisst die Hauptstadt von Spanien?', a: 'madrid' },
            { q: 'Wie heisst die Hauptstadt der Schweiz?', a: 'bern' },
            { q: 'Wie heisst die Hauptstadt von Oesterreich?', a: 'wien' },
            { q: 'Wie heissen die drei Staatsgewalten in einer Demokratie? Nenne eine.', a: 'legislative' },
            { q: 'Wie heisst das wichtigste Gesetz in Deutschland?', a: 'grundgesetz' },
            { q: 'Wie heisst das deutsche Parlament im Bund?', a: 'bundestag' },
            { q: 'Wie heisst das Oberhaupt der Regierung in Deutschland?', a: 'bundeskanzler' },
            { q: 'Ab welchem Alter darf man in Deutschland (bei Bundestagswahlen) waehlen? (Stand 2024)', a: '18' },
            ...
            { q: 'Wie heisst die kleinste Einheit der Materie (in der Grundschulebene)?', a: 'atom' },
            { q: 'Wie viele Gradzahlen hat ein rechter Winkel?', a: '90' },
            { q: 'Welcher Stromkreis braucht eine Batterie/Stromquelle und mindestens ein Geraet — wie heisst er?', a: 'stromkreis' },
            { q: 'Was darf man im Stromkreis NICHT mit nassen Haenden anfassen? (z.B. Steckdose)', a: 'steckdose' },
            { q: 'Welches Material leitet Strom: Holz, Metall, Plastik?', a: 'metall' },
            { q: 'Welches Material isoliert Strom (leitet ihn nicht): Metall oder Plastik?', a: 'plastik' },
            { q: 'Welche Erfindung von James Watt veraenderte die Industrie? (Buchdruck, Dampfmaschine, Auto)', a: 'dampfmaschine' },
            { q: 'In welchem Jahr fiel die Berliner Mauer (Jahrhundert)? (1989, 1945, 1815)', a: '1989' },
            { q: 'Welcher Krieg endete 1945? (Erster Weltkrieg, Zweiter Weltkrieg)', a: 'zweiter weltkrieg' },
            { q: 'Wie viele Bundeslaender hat Deutschland?', a: '16' },
            { q: 'Wie heisst das groesste Bundesland (Flaeche)?', a: 'bayern' },
            { q: 'Wie heisst der hoechste Berg Deutschlands?', a: 'zugspitze' },
            { q: 'In welchem Bundesland liegt die Zugspitze?', a: 'bayern' },
            { q: 'Wie heisst der laengste Fluss, der durch Deutschland fliesst (komplett oder teilweise)?', a: 'rhein' },
            { q: 'Welcher See ist der groesste deutsche Anteil-See? (Bodensee, Mueggelsee, Chiemsee)', a: 'bodensee' },
            { q: 'Welche Waehrung gilt in Deutschland?', a: 'euro' },
            { q: 'Wie viele Cent ergeben einen Euro?', a: '100' },
            { q: 'Welche Religion bekennt sich zu Jesus Christus?', a: 'christentum' },
            { q: 'In welchem Kontinent liegt China?', a: 'asien' },
            { q: 'In welchem Kontinent liegt Brasilien?', a: 'suedamerika' },
            { q: 'Welche Sprache spricht man in England?', a: 'englisch' },
            { q: 'Wie heisst der hoechste Berg der Welt?', a: 'mount everest' },
            { q: 'In welchem Kontinent liegt der Mount Everest?', a: 'asien' },
            { q: 'Wie heisst der laengste Fluss der Welt?', a: 'nil' },
            { q: 'In welchem Kontinent fliesst der Nil?', a: 'afrika' },
            { q: 'Wie heisst der groesste Ozean der Welt?', a: 'pazifik' },
            { q: 'Welcher Ozean liegt zwischen Europa und Amerika?', a: 'atlantik' },
            { q: 'Wie heisst der Planet, der die Erde umkreist (Trabant)?', a: 'mond' },
            { q: 'Welcher Planet ist der groesste in unserem Sonnensystem?', a: 'jupiter' },
            { q: 'Welcher Planet wird wegen seiner Ringe beruehmt?', a: 'saturn' },
            { q: 'Wie viele Planeten hat unser Sonnensystem (offiziell, ohne Pluto)?', a: '8' },
            { q: 'Welche Form hat die Erde (annaehernd)?', a: 'kugel' },
            { q: 'Was bezeichnet die Sonne? Ein/eine ... (Stern, Planet, Mond)', a: 'stern' },
            { q: 'Wie heisst die Schicht aus Luft um die Erde?', a: 'atmosphaere' },
            { q: 'Welche Erfindung erfand Gutenberg um 1450? (Buchdruck)', a: 'buchdruck' },
            { q: 'In welchem Jahrhundert lebte Martin Luther? (16. Jahrhundert)', a: '16' },
            { q: 'Welcher Forscher entdeckte 1492 Amerika (aus europaeischer Sicht)? (Kolumbus)', a: 'kolumbus' },
            { q: 'In welchem Jahr endete der Zweite Weltkrieg?', a: '1945' },
            { q: 'Welche Wand teilte Berlin von 1961 bis 1989?', a: 'berliner mauer' },
            { q: 'In welchem Jahr fand die deutsche Wiedervereinigung statt?', a: '1990' },
            { q: 'Wie heisst die deutsche Nationalhymne (Anfangsworte)? (Einigkeit und Recht und Freiheit)', a: 'einigkeit und recht und freiheit' },
            { q: 'Welche Farben hat die deutsche Flagge?', a: 'schwarz rot gold' },
            { q: 'Welche Tiere sind die Wahrzeichen Berlins (Tier im Wappen)? (Baer)', a: 'baer' },
            { q: 'Wie heisst der Bundespraesident-Sitz in Berlin? (Schloss Bellevue)', a: 'schloss bellevue' },
            { q: 'Wie heisst das deutsche Verfassungsgericht-Stadt? (Karlsruhe)', a: 'karlsruhe' },
            { q: 'Wie heisst die Hauptstadt der Schweiz?', a: 'bern' },
            { q: 'Welche Sprache spricht man in der Schweiz (Mehrheit)? (Deutsch, Franzoesisch, Italienisch, Ratoromanisch). Eine reicht.', a: 'deutsch' },
            { q: 'Welche Waehrung hat die Schweiz?', a: 'schweizer franken' },
            { q: 'Welche Waehrung hat Grossbritannien?', a: 'pfund' },
            { q: 'Welche Waehrung hat die USA?', a: 'dollar' },
            { q: 'In welchem Kontinent liegt Australien?', a: 'australien' },
            { q: 'In welchem Kontinent liegt Kanada?', a: 'nordamerika' },
            { q: 'In welchem Kontinent liegt Indien?', a: 'asien' },
            { q: 'In welchem Kontinent liegt Russland (groesster Anteil)?', a: 'asien' },
            { q: 'Welche Tiere haben Federn? (Voegel)', a: 'voegel' },
            { q: 'Welche Tiere haben Fell und saugen ihre Jungen?', a: 'saeugetiere' },
            { q: 'Welche Tiere atmen Wasser durch Kiemen?', a: 'fische' },
            { q: 'Welche Tiere haben Schuppen und legen Eier auf Land? (Reptilien)', a: 'reptilien' },
            { q: 'Welche Tiere leben sowohl im Wasser als auch an Land? (Amphibien)', a: 'amphibien' },
            { q: 'Welches Organ pumpt das Blut?', a: 'herz' },
            { q: 'Welches Organ atmet Sauerstoff in den Koerper?', a: 'lunge' },
            { q: 'Welches Organ steuert den Koerper (Denken)?', a: 'gehirn' },
            { q: 'Welche Knochenstruktur traegt den Koerper?', a: 'skelett' },
            { q: 'Wie viele Knochen hat der erwachsene Mensch ungefaehr?', a: '206' },
            { q: 'Wie viele Zaehne hat ein erwachsener Mensch ungefaehr (mit Weisheitszaehnen)?', a: '32' },
            { q: 'Wie heisst der Vorgang, bei dem Pflanzen ihre Energie aus Sonne machen?', a: 'photosynthese' },
            { q: 'Welche Gase brauchen Pflanzen zur Photosynthese? (CO2)', a: 'kohlendioxid' },
            { q: 'Welche Gase geben Pflanzen ab? (Sauerstoff)', a: 'sauerstoff' },
            { q: 'Wie heisst der Vorgang, bei dem ein Apfel von gruen zu rot wird? (Reifen)', a: 'reifen' },
            { q: 'Welcher Magnetpol stoesst einen Nordpol ab?', a: 'nordpol' },
            { q: 'Welcher Magnetpol zieht einen Nordpol an?', a: 'suedpol' },
            { q: 'Welches Material leitet Strom: Holz, Eisen, Glas?', a: 'eisen' },
            { q: 'Welches Material leitet keinen Strom: Holz, Kupfer, Eisen?', a: 'holz' },
            { q: 'Welche Erfindung des 19. Jahrhunderts bewegte sich auf Schienen? (Eisenbahn)', a: 'eisenbahn' },
            { q: 'Welche Erfindung um 1879 brachte Edison hervor? (Gluehlampe)', a: 'gluehlampe' },
            { q: 'In welchem Bundesland liegt Dresden?', a: 'sachsen' },
            { q: 'In welchem Bundesland liegt Hannover?', a: 'niedersachsen' },
            { q: 'In welchem Bundesland liegt Stuttgart?', a: 'baden-wuerttemberg' },
            { q: 'Welcher Fluss fliesst durch Frankfurt am Main?', a: 'main' },
            { q: 'Welche Stadt ist die zweitgroesste Deutschlands? (Hamburg)', a: 'hamburg' },
            { q: 'Welche Stadt ist die groesste Deutschlands?', a: 'berlin' },
            { q: 'Wie viele Einwohner hat Deutschland ungefaehr (in Millionen, Stand grob)? (80, 100, 50)', a: '80' },
            { q: 'Wie viele Tage hat ein Schaltjahr?', a: '366' },
            { q: 'Wie viele Tage hat ein normales Jahr?', a: '365' },
            { q: 'Welche Jahreszeit beginnt um den 21. Maerz?', a: 'fruehling' },
            { q: 'Welche Jahreszeit beginnt um den 21. Juni?', a: 'sommer' },
            { q: 'Welche Jahreszeit beginnt um den 23. September?', a: 'herbst' },
            { q: 'Welche Jahreszeit beginnt um den 21. Dezember?', a: 'winter' },
            { q: 'Welcher Vogel ist ein Wappentier Deutschlands? (Adler)', a: 'adler' }
        ];
    }
