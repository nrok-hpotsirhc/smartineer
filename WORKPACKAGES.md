...
> **Naechster Batch-Anker (vom Agent gesetzt):** **P-AUTO-LABS** (PBQ-/Fall-Labs SPS, Antrieb, Feldbus, Robotik) — nach beiden Capstones (Cybersec Kap. 10, Automation Kap. 7) ist die didaktische Tiefe der Master-Strecken auf Pruefungsniveau. P-AUTO-LABS ergaenzt pruefungsnahe PBQ-/Fall-Labs ohne neue Kapitel und ist eine sinnvolle Erweiterung des Automation-Capstones (gleiche Datei). Alternativ-Anker: **P-AUTO-07** (Sensorik/Messtechnik) als naechstes inhaltliches Master-Kapitel oder **P-LP-EXAM-MODE** als Architektur-Schritt fuer den Pruefungsmodus.
> Begruendung: Beide Master-Capstones sind v48/v49 produktiv. Labs sind eine logische Erweiterung mit niedrigerem Recherche-Aufwand pro Item (bestehende Lehrseiten-Wissensbasis) und liefern PBQ-Items, die spaeter via P-LP-EXAM-MODE pruefungsfaehig werden. Inhaltliche Top-ups (P-AUTO-07/08/09, P-CYBERSEC-CAPSTONE-TOPUP) bleiben ready.
